...
#define BOARD_MODBUS_UART_BASE       HPM_UART2
#define BOARD_MODBUS_UART_IRQ        IRQn_UART2
#define BOARD_MODBUS_UART_BAUDRATE   (115200UL)
#define BOARD_MODBUS_UART_CLK_NAME   clock_uart2
#define BOARD_MODBUS_UART_RX_DMA_REQ HPM_DMA_SRC_UART2_RX
#define BOARD_MODBUS_UART_TX_DMA_REQ HPM_DMA_SRC_UART2_TX
